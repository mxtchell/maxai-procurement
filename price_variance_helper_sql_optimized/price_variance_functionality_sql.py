...
def generate_visualizations(supplier_df: pd.DataFrame, contract_df: pd.DataFrame, 
    ...
    page1_vars = {
        ...
        # Insights
        "exec_summary": generate_insights_markdown(kpi_data, supplier_df, top_supplier)
    }
    ...
    if not contract_df.empty:
        ...
        page2_vars = {
            ...
            "exec_summary": generate_contract_insights(contract_df, top_supplier, total_contract_variance)
        }
